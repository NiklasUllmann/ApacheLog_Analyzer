...
def main():
    ...
    def update_output(start_date, end_date):
        if start_date is not None and end_date is not None:
            ...
            ref = getReferrer(copy.deepcopy(y))
            rc = getRequestCount(copy.deepcopy(y))
            scc = getStatusCodeCount(copy.deepcopy(y))
            tscc = getStatusCodeTimeLine(copy.deepcopy(y))
            uh = getUsageHours(copy.deepcopy(y))
            ud = getUsageDays(copy.deepcopy(y))
